...
export const AboutSection = ({ scale }: { scale: number }) => {
  return (
    <section
      className=" relative flex flex-col items-center justify-center min-h-screen w-full mx-auto h-screen mt-30"
      style={{
        scale: scale,
      }}
      id="about"
    >
      <div className="text-blue-400 sm:text2xl md:text-4xl lg:text-6xlfont-semibold">
        About me!
      </div>
      <div
        className="grid
        ...
        <div className=" flex flex-col lg:flex-row items-center justify-center text-white gap-10 px-20 py-10">
          <div className="flex flex-col items-center justify-center text-white w-full">
            <div className="relative w-full aspect-square">
              <Image
                className="aspect-square px-10 rounded-full"
            ...
            <p className="text-2xl text-center px-20">
              ...
              training at ERXES Academy. I enjoy turning designs into
              functional, responsive websites using modern web technologies. I
              am committed to continuous self-improvement and building
              real-world projects.
            </p>
          </div>
